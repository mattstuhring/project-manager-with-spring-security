...
public class BacklogController {
    ...
    public ResponseEntity<?> getProjectTask(@PathVariable String backlog_id, @PathVariable String pt_sequence) {
        ...
        ProjectTask pt = projectTaskService.findProjectTaskByProjectSequence(backlog_id, pt_sequence);
    ...
    public ResponseEntity<?> updateProjectTask(@Valid @RequestBody ProjectTask projectTask,
        ...
        ProjectTask updatedTask = projectTaskService.updateByProjectTaskSequence(projectTask, backlog_id, pt_sequence);
    ...
    public ResponseEntity<?> deleteProjectTask(@PathVariable String backlog_id, @PathVariable String pt_sequence) {
        projectTaskService.deleteProjectTaskByProjectTaskSequence(backlog_id, pt_sequence);
